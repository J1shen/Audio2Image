...
def main():
    ...
    def preprocess_train(examples):
        examples["pixel_values"] = train_transforms(read_img(examples['image']))
    ...
    with accelerator.main_process_first():
        ...
        train_dataset = dataset["train"].map(preprocess_train,remove_columns=dataset["train"].column_names)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                audio_hidden_states = audio_encoder(batch["input_ids"])
                ...
                model_pred = unet(noisy_latents, timesteps, audio_hidden_states).sample
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.checkpointing_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        torch.save(audio_encoder.state_dict(),'./encoder_ckpt')
    ...
    if accelerator.is_main_process:
        ...
        pipeline = StableDiffusionPipeline.from_pretrained(
            args.pretrained_model_name_or_path,
            text_encoder=audio_encoder,#text_encoder
            vae=vae,
            unet=unet,
            revision=args.revision,
        )
